window.addEventListener("load", () => {
    ...
    const categories: categoryCollection = [
        ...
        category:"Limiti notevoli",
            questions:[
                { prompt:"per x->0, Lim sin(x)/x", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} {\\sin x \\over x}",prompt:"uguale a"}, answer:"1" },
                { prompt:"per x->0, Lim ln(1+x)/x", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} { \\ln (1+x) \\over x }",prompt:"uguale a"}, answer:"1" },

                { prompt:"per x->0, Lim tan(x)/x", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} { \\tan (x) \\over x }",prompt:"uguale a"}, answer:"1" },
                { prompt:"per x->0, Lim (e^x-1)/x", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} { e^x - 1 \\over x }",prompt:"uguale a"}, answer:"1" },
                { prompt:"per x->0, Lim arctan(x)/x", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} { \\arctan x \\over x }",prompt:"uguale a"}, answer:"1" },
                { prompt:"per x->0, Lim arcsin(x)/x", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} { \\arcsin x \\over x }",prompt:"uguale a"}, answer:"1" },

                { prompt:"per x->0, Lim sin(x)", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} \\sin x",prompt:"uguale a"}, answer:"x" },
                { prompt:"per x->0, Lim ln(1+x)", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} \\ln (1+x)",prompt:"uguale a"},answer:"x" },
                { prompt:"per x->0, Lim tan(x)", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} \\tan x",prompt:"uguale a"}, answer:"x" },
                { prompt:"per x->0, Lim (e^x-1)", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} e^x - 1",prompt:"uguale a"}, answer:"x" },
                { prompt:"per x->0, Lim arctan(x)", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} \\arctan x",prompt:"uguale a"}, answer:"x" },
                { prompt:"per x->0, Lim arcsin(x)", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} \\arcsin x",prompt:"uguale a"}, answer:"x" },

                { prompt:"per x->0+, Lim xln(x)", promptMathJax:{equation:"\\lim_{x \\rightarrow 0^+} x \\ln x",prompt:"uguale a"}, answer:"0"},
                { prompt:"per x->0, Lim (a^x-1)/x", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} {a^x - 1 \\over x}",prompt:"uguale a"}, answer:["ln(a)","log(a)"]},
                { prompt:"per x->0, Lim (1-cos(x))/x^2", promptMathJax:{equation:"\\lim_{x \\rightarrow 0} {1 - \\cos x \\over x^2}",prompt:"uguale a"}, answer:"1/2"},

                { prompt:"per x->infinito, Lim (1+1/x)^x", promptMathJax:{equation:"\\lim_{x \\rightarrow \\infty} (1 + {1 \\over x})^x",prompt:"uguale a"}, answer:"e" },
                { prompt:"per x->infinito, Lim (1+x)^-x", promptMathJax:{equation:"\\lim_{x \\rightarrow \\infty} (1 + x)^{-x}",prompt:"uguale a"}, answer:"e" },

                { prompt:"per x->infinito, Lim (1+a/x)^x", promptMathJax:{equation:"\\lim_{x \\rightarrow \\infty} (1 + {a \\over x})^x",prompt:"uguale a"}, answer:"e^a" },
            ]
        },
        {
        category:"Serie note",
